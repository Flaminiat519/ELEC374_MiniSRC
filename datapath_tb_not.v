...
module datapath_tb_not;
  ...
  always @(Present_state) begin
    case (Present_state)
      ...
      Reg_load1b: begin
        deassert_all();
        MDRout <= 1; R7in <= 1;  //Initialize R5 with 52
      end

      T0: begin
        deassert_all();
        //Fetch instruction address (fake rn)
      ...
      T1: begin
        ...
        //Read instruction
        Read <= 1; MDRin <= 1;
        MDatain <= 32'b01111000000000000000000000000000; //neg R4, R7
      end
      ...
      T4: begin
        ...
        //NEG operation
        Zin <= 1;
        force DUT.alu_op = (13'b1 << 2);  //NEG index 3
      end
