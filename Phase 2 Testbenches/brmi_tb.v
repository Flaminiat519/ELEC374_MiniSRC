...
// ================================================================
//  Testbench: tb_brmi
//  brmi R3, 48  — branch if R3 < 0 (MSB=1)
//
//  Case 1 (TAKEN):     R3=0xFFFFFFFF -> CON=1 -> PC jumps to 0x41
//  Case 2 (NOT TAKEN): R3=0x00000007 -> CON=0 -> PC stays at 0x11
//
//  brmi: opcode=5'b10101, C2=2'b11 -> IR[22:19]=4'b0011
// ================================================================
module tb_brmi;
    ...
    // brmi R3, 48: C2=11 -> IR[22:19]=4'b0011
    localparam IR_BRMI = {5'b10101, 4'd3, 4'b0011, 19'd48};
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            // ═══════════════════════════════════
            // Case 1: TAKEN — R3=0xFFFFFFFF (negative, MSB=1)
            // ═══════════════════════════════════
            Default: begin
                force DUT.R3_reg.q     = 32'hFFFFFFFF;
                force DUT.PC_reg.qTemp = 32'h00000010;
                force DUT.IR_reg.q     = IR_BRMI;
            end
            C1_T0: begin
            ...
            // ═══════════════════════════════════
            // Case 2: NOT TAKEN — R3=7 (positive)
            // ═══════════════════════════════════
            C2_T0: begin
    ...
    always @(posedge clock) begin
        ...
        case (Present_state)
            C1_Done: begin
                $display("-- brmi Case 1: TAKEN (R3=0xFFFFFFFF, negative) --");
                check(DUT.CON_unit.CON,  1'b1,        "CON FF = 1");
                check(DUT.PC_reg.qTemp,  32'h00000041, "PC = 0x41 (branch taken)");
            end
            DONE: begin
                $display("-- brmi Case 2: NOT TAKEN (R3=0x7, positive) --");
