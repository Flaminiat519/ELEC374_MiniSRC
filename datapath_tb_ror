...
module datapath_tb_ror;
  ...
  always @(Present_state) begin
    case (Present_state)
      ...
      Reg_load2a: begin
        deassert_all();
        MDatain <= 32'h00000071;
        Read <= 1; MDRin <= 1;
      end

      Reg_load2b: begin
        deassert_all();
        MDRout <= 1; R4in <= 1;  //Initialize R4 with 0x71
      end
      ...
      T1: begin
        ...
        Read <= 1; MDRin <= 1;
        MDatain <= 32'h02020202;  //Opcode for "rol R7, R0, R4"
      end
      ...
      T4: begin
        ...
        R4out <= 1; Zin <= 1;
        force DUT.alu_op = (13'b1 << 11);  //ROR index 11
      end
