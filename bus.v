//Bus multiplexer — routes one of the register/component outputs onto the shared bus
module Bus (
	//32-bit data inputs from all registers and components
	...
	input [31:0] INPORT,
	//Output enable signals — one per register/component
	...
	//Selected value driven onto the bus
	output reg [31:0] BusMuxOut
);
	//Drive BusMuxOut with whichever source has its output enable asserted
	always @(*) begin
		...
		else BusMuxOut = 32'b0; //Default to 0 if nothing is asserted
	end
endmodule
